      ...
      <div className="stats-grid">
        <div className="stat-card blue">
          ...
          <div className="stat-content">
            ...
            <div className="stat-change positive">
              +{Math.floor(Math.random() * 20)}% tháng này
            </div>
          </div>
        </div>
        ...
        <div className="stat-card green">
          ...
          <div className="stat-content">
            ...
            <div className="stat-change positive">
              +{Math.floor(Math.random() * 15)}% tháng này
            </div>
          </div>
        </div>
        ...
        <div className="stat-card purple">
          ...
          <div className="stat-content">
            ...
            <div className="stat-change positive">
              +{Math.floor(Math.random() * 10)}% tháng này
            </div>
          </div>
        </div>
        ...
        <div className="stat-card orange">
          ...
          <div className="stat-content">
            ...
            <div className="stat-change positive">
              +{Math.floor(Math.random() * 25)}% tháng này
            </div>
          </div>
        </div>
      </div>
              ...
              {stats.recentJobs.slice(0, 8).map((job, idx) => (
                <div key={idx} className="job-item">
                  ...
                  <span className={`status-badge ${job.status}`}>
                    {job.status === 'active' ? '✅' : '⏸️'} {job.status}
                  </span>
                </div>
              ))}
            </div>
